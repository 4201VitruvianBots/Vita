...
Homepage for [4201VitruvianBots/Vita](https://github.com/4201VitruvianBots/Vita). New users opening a Codespace should start with **[WELCOME.md](WELCOME.md)** (opens as a formatted preview). Use the command palette command **Vita: Return to Index** to open [docs/Index.md](docs/Index.md). Users link their GitHub account, fork the repository into their account, and launch a VS Code Codespace on their fork.
