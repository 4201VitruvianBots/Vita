...
Homepage for [4201VitruvianBots/Vita](https://github.com/4201VitruvianBots/Vita). New users opening a Codespace should start with **[WELCOME.md](WELCOME.md)**. Navigate to **[docs/Index.md](docs/Index.md)** via the link in WELCOME, `Ctrl+Shift+~`, or Quick Open (`Ctrl+P` → `Index`). Users link their GitHub account, fork the repository into their account, and launch a VS Code Codespace on their fork.
